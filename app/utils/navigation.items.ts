...
export const mainNavigationItems = computed<NavigationMenuItem[][]>(() => [
  [
    {
      label: 'Strona główna',
      icon: 'i-lucide-home',
...
export const mobileNavigationItems = computed<NavigationMenuItem[][]>(() => [
  [{
...
// User navigation menu items - static structure
export const userNavigationMobileItems: NavigationMenuItem[][] = [
  [
    {
...
export const userDropdownItems: DropdownMenuItem[][] = [
  [{
    label: 'ben@example.com',
    slot: 'account',
    disabled: true
