...
export function useDocumentation() {
  ...
  //  */
  // const getAccessibleDocuments = async <T extends keyof Collections>(collection: T = 'docs' as T) => {
  //   // W Nuxt Content 3 używamy queryCollection
  //   const docs = await queryCollection(collection)
  //     // .select('title', 'description', 'category', 'requiredRole', 'path')
  //     .all();
  ...
  //  */
  // const getAccessibleNavigation = async <T extends keyof Collections>(collection: T = 'docs' as T) => {
  ...
  //  */
  // const getDocumentSurroundings = async <T extends keyof Collections>(path: string, collection: T = 'docs' as T) => {
  ...
  //  */
  // const searchDocuments = async <T extends keyof Collections>(query: string, collection: T = 'docs' as T) => {
