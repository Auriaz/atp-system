...
<template>
    <div v-if="value" :class="[
        'w-full ',
        isNested ? 'my-0' : 'rounded-lg overflow-hidden border bg-basic-900/95 dark:bg-basic-950/95 backdrop-blur-sm shadow-lg shadow-black',
        open ? 'pb-1' : '',
        classBorderColor,
    ]">
        <!-- Header - tylko dla głównego dumpa -->
        <div v-if="!isNested && isHeader" 
