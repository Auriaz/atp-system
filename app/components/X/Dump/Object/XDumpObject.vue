            ...
            <div v-if="open" class="pl-4 mt-1">
                ...
                <div class="pl-4">
                    <div v-for="(item, idx) in value" :key="idx">
                        <x-dump-string v-if="typeof item === 'string'" :value="item" :index="idx" />
                        <x-dump-boolean v-if="typeof item === 'boolean'" :value="item" :index="idx" />
                        <x-dump-number v-if="typeof item === 'number'" :value="item" :index="idx" />
                        <x-dump-object v-if="typeof item === 'object'" :value="item" :index="idx" />
                    </div>
                </div>
