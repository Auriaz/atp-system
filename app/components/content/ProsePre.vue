<template>
  <div class="relative my-4 bg-gray-800 rounded-lg p-1 leading-relaxed shadow-md transition-colors duration-300 ease-in-out">
    <div class="flex items-center  rounded-t-lg px-4 py-2 text-gray-500 dark:text-gray-400 bg-slate-950 p-2 rounded-lg">
    ...
    <pre :class="$props.class" class="overflow-x-auto font-mono text-sm whitespace-pre-line px-4 pt-4">
      <slot />
    </pre>
  </div>
</template>
